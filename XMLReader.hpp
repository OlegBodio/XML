#include "Section.hpp" // вообще порядок инклудов странный, что я даже сам толком не понимаю его. Но обычно системные инклуды помещают в вверх, а свои уже потом
